...
WebUI.setText(findTestObject('Module/Test Form/input_Mobile number'), '98765432')
...
WebUI.sendKeys(findTestObject('Module/Test Form/input_Date of Birth'), '0d/01/1990')

WebUI.click(findTestObject('Module/Test Form/checkbox_Music'))

'Verify field validation for date format'
WebUI.verifyTextPresent('Please enter a valid date', false)
